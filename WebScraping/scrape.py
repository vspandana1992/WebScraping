...
class _scrape(object):
    def __call__(self,args):
        ...
        if args.w.lower() == 'stocksnap'   : urls = stocksnap(args.q.lower(), args.p)
        if args.w.lower() == 'flickr'   : urls = flickr(args.q.lower())
...
if __name__=='__main__':
    ...
    parser.add_argument('-w', choices = ['unsplash','stocksnap','flickr'], metavar = 'website', required = True, type = str,
                        help = 'name of the website that you want to scrape data from, example: unsplash,stocksnap,flickr')
